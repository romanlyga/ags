...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5fdb4bee85b6680015d3e2ab
...
To start editing your site, you can use the Sanity interface at https://ags-b4bee.sanity.studio/.
...
Generated at `2020-12-17T12:16:01.191Z` by Stackbit version `0.3.40`.